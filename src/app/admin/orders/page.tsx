      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4">
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <select
            ...
            className="border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-700 bg-white focus:border-[#B5748A] focus:ring-1 focus:ring-[#B5748A]/20 focus:outline-none transition-colors"
          >
                  ...
                  >
                    <td className="px-4 py-3">
                      <Link
                        ...
                        className="font-medium text-[#B5748A] hover:underline"
                      >
                        {order.orderNumber}
                      </Link>
                    </td>
