          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <a
                  href={item.href}
                  className={`block px-4 lg:px-5 py-2.5 text-[13px] lg:text-[14px] font-normal whitespace-nowrap transition-colors relative after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-[2px] after:bg-[#B5748A] after:transition-all ${
                    activeMenu === item.label
                      ? "text-[#B5748A] after:w-full"
                      : "text-[#1C2120] hover:text-[#B5748A] after:w-0 hover:after:w-full"
                  }`}
                >
                  {item.label}
                </a>
            ...
            >
              {currentMenu.map((col) => (
                <div key={col.title} className="mega-col">
                  <h4 className="text-[13px] font-semibold text-[#B5748A] mb-2.5 pb-1.5 border-b border-[#B5748A]/10">
                    {col.title}
                  </h4>
                  <ul className="space-y-1.5">
                    {col.links.map((link) => (
                      <li key={link.label}>
                        <a
                          href={link.href}
                          className="text-[13px] text-[#464646] hover:text-[#B5748A] transition-colors block py-0.5"
                        >
                          {link.label}
                        </a>
                      </li>
