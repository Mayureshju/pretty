          ...
          <div ref={infoRef} className="lg:w-[45%]">
            ...
            {product.metrics.averageRating > 0 && (
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-sm text-[#0E4D65]">{product.metrics.ratingCount} Reviews</span>
              </div>
            )}
                      ...
                      {p.metrics.averageRating > 0 && (
                        <div className="flex items-center gap-1.5 mt-1">
                          ...
                          {p.metrics.ratingCount > 0 && (
                            <span className="text-[10px] text-[#0E4D65]">({p.metrics.ratingCount.toLocaleString()})</span>
                          )}
                        </div>
                      )}
                    </div>
