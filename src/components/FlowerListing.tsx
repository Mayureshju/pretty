  ...
  return (
    <div className="max-w-[1320px] mx-auto px-4">
          ...
          {filterChips.map((chip) => (
            <button
              ...
              className={`shrink-0 px-4 py-2 rounded-full text-sm font-medium border transition-all duration-200 cursor-pointer ${
                activeFilter === chip
                  ? "bg-[#0E4D65] text-white border-[#0E4D65]"
                  : "bg-white text-[#1C2120] border-gray-200 hover:border-[#0E4D65] hover:text-[#0E4D65]"
              }`}
            >
              {chip}
            </button>
      ...
      >
        {allProducts.map((product, i) => (
          ...
          >
            ...
            {/* Product Image */}
            <a href={`/p/flower/${product.id}`} className="block">
              <div className="relative w-full aspect-[4/5] overflow-hidden bg-[#f5f5f5]">
                ...
                <div className="absolute bottom-2.5 left-3 flex items-center gap-1">
                  <span className="w-2 h-2 rounded-full bg-[#0E4D65]" />
            ...
            <div className="p-3 md:p-4">
              ...
              <div className="flex items-center justify-between mt-2.5">
                <p className="text-[11px] md:text-xs text-[#999]">
                  Earliest Delivery : <span className="text-[#0E4D65] font-semibold">{product.delivery}</span>
                </p>
                <button className="text-[#888] hover:text-[#0E4D65] transition-colors cursor-pointer" title="More info">
      ...
      <div className="flex justify-center py-8">
        <button className="px-10 py-3 text-sm font-semibold border-2 border-[#0E4D65] text-[#0E4D65] rounded-lg transition-all duration-300 hover:bg-[#0E4D65] hover:text-white hover:shadow-lg cursor-pointer">
          Load More Flowers
        </button>
      </div>
    </div>
