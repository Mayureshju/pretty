...
// Every href must be a live category path. Tiles for "Gift Hampers"
// (/hampers/same-day-delivery), "Flower Boxes" (/flowers/in-box) and "Premium
// Plants" (/plants/premium) were dropped because no such category exists.
const collections = [
  ...
  { title: "Corporate Gifts", href: "/flowers/corporate/", image: "/images/products/corporate-gifts.jpg" },
];
